...
- [plugin-ext] add finer-grained logging of back-end start-up, especially plugin deployment [#](https://github.com/eclipse-theia/theia/pull/#). Contributed on behalf of STMicroelectronics
